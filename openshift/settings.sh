...
export PROJECT_NAMESPACE="pssg-cscp-cpu"
...
export GIT_URI="https://github.com/JonTaylorBCGov/pssg-cscp-cpu.git"
export GIT_REF="development"

# The project components
# - defaults to the support the Simple Project Structure
export components=${components:-"cpu-app"}

# The builds to be triggered after buildconfigs created (not auto-triggered)
export builds=${builds:-""}

# The images to be tagged after build
export images=${images:-"cpu-app"}
